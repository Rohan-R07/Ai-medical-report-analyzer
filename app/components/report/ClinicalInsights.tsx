    ...
    <div className="w-full max-w-2xl mx-auto space-y-6">
      ...
      <div className="space-y-1">
        <h2 className="text-xl font-bold font-heading text-slate-800 flex items-center space-x-2">
          <MessageSquareDot className="w-5 h-5 text-teal-600" />
      ...
      {/* Interactive steps */}
      <div className="relative border-l border-slate-100 pl-6 ml-3 space-y-6 py-1">
        {insights.map((insight, idx) => (
          ...
          >
            ...
            <span className="absolute -left-[37px] top-0.5 w-6 h-6 rounded-full bg-white border border-slate-100 flex items-center justify-center shadow-sm">
              {insight.icon}
            </span>

            <div className="space-y-1.5 bg-white border border-slate-100 p-5 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
