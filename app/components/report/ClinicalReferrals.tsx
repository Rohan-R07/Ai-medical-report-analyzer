...
import { Stethoscope, ShieldAlert, ArrowRight, ShieldCheck } from "lucide-react";
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              {activeFollowUps.slice(0, 3).map((test, idx) => (
                <div key={idx} className="flex items-start space-x-2.5 text-xs text-slate-600 font-normal leading-normal">
          ...
          <div className="border-t border-slate-100 pt-3 space-y-2">
            ...
            <div className="space-y-2">
              {activeNextSteps.slice(0, 3).map((step, idx) => (
                <div key={idx} className="flex items-start space-x-2 text-xs text-slate-600 font-normal leading-normal">
